...
class Highscore():
    ...
    def add_scores(self, score1, score2, score3=None, score4=None):      # will be used as refresh
        ...
        player1 = ("Player 1", players.get("Player 1") + score1)
        player2 = ("Player 2", players.get("Player 2") + score2)
        player3 = ("Player 3", players.get("Player 3", None) + score3)
        player4 = ("Player 4", players.get("Player 4", None) + score4)
